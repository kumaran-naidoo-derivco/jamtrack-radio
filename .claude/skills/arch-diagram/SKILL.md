...
Rounded rectangle carries the readable label; a 24×24 Azure icon child sits in the top-right corner as a resource-type indicator. Keeps logical diagram readability while showing the underlying service type at a glance.
...
- `parent="COMPONENT_ID"` — icon is a child of its rectangle (coordinates are relative)
