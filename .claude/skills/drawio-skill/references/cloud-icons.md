...
| manage_monitor | Monitor, Log_Analytics_Workspaces, Application_Insights, Automation_Accounts |
...
<!-- Redis Cache -->
image=img/lib/azure2/databases/Azure_Cache_for_Redis.svg
```
...
```xml
<!-- Monitor -->
image=img/lib/azure2/manage_monitor/Monitor.svg

<!-- Log Analytics -->
image=img/lib/azure2/manage_monitor/Log_Analytics_Workspaces.svg

<!-- Application Insights -->
image=img/lib/azure2/manage_monitor/Application_Insights.svg

<!-- Automation -->
image=img/lib/azure2/manage_monitor/Automation_Accounts.svg
```
