...
![Trust Boundaries](diagrams/trust-boundaries.drawio.svg)

> Source: [`diagrams/trust-boundaries.drawio.svg`](diagrams/trust-boundaries.drawio.svg) — draw.io editable SVG (embedded diagram)
